...
const UserDetails = forwardRef(({ userid, username, phone, email, role, editable = false }, ref) => {
        ...
        <dialog ref={ref} id={userid} className="modal">
            <div className="modal-box rounded-lg flex items-center flex-col gap-3">
                ...
                <div className='grid grid-cols-2 gap-2'>
                    ...
                    <SelectRoles role = {Role}/>
                    {/* <InputField type="text" disabled={!editable} label="Role" onChange={(e) => setRole(e.target.value)} value={Role} green={true} className="font-semibold" /> */}
                </div>
                <div className="flex flex-col w-full items-center">
                    ...
                    {role === "unverified" ? <div className='gap-2 w-full flex flex-col items-center'>
                        <Button className="w-full flex-grow p-0" type="submit" background="#0F7275" color="#F7FAFC" label="Approve"></Button>
